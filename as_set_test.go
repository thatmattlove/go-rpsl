...
func Test_ASSetName(t *testing.T) {
	t.Run("dash", func(t *testing.T) {
		t.Parallel()
		assert.Equal(t, value.V("AS-65000"), rpsl.ASSetName("AS-65000"))
	})
	t.Run("no dash", func(t *testing.T) {
		t.Parallel()
		assert.Equal(t, value.V("AS-65000"), rpsl.ASSetName("AS65000"))
	})
	t.Run("no prefix", func(t *testing.T) {
		t.Parallel()
		assert.Equal(t, value.V("AS-65000"), rpsl.ASSetName("65000"))
	})
}
